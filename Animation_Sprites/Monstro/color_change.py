...
#             print("Red: {0}, Green: {1}, Blue: {2}, pixel = x:{3}, y:{4}".format(r, g, b, x, y))
#             image_obj.putpixel((x, y), (0, 238, 0))
#             image_obj.save(saved_location)
#
#
# if __name__ == '__main__':
#     image = 'plain-red-background.jpg'
#     colored_image(image, 'plain-red-background.jpg')
